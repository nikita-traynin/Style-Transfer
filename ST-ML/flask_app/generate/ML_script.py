...
def generate_and_save(style_image_name, content_image_name):
    ...
    # style_image_name = 'Pointillist-landscape.jpg'
    # content_image_name = 'mountain-landscape.jpg'
    ...
    def show_image(tensor):
        ...
        image = np.transpose(tensor.squeeze(0).clone().cpu().detach().numpy(), axes=(1, 2, 0))
    ...
    for iter_count in range(1, steps + 1):
        ...
        if iter_count % display_interval == 0:
            print("Done with " + str(iter_count) + "iterations. ")
